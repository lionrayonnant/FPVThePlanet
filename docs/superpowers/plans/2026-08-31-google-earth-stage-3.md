...
- Modify: `sim/README.md` — section fournisseurs : les deux inscrits, le défaut, `--provider`, le cache `.cache/google-earth/`, la régénération des fixtures (`gen-rocktree-fixture.mjs` + un HAR frais).
